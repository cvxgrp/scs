...
void BLAS(gemv)(const char *trans, blasint *m, blasint *n, scs_float * alpha, scs_float *a, blasint *lda, const scs_float *x, blasint *incx,
...
void BLAS(syrk)(const char *uplo, const char *trans, blasint *n, blasint *k, scs_float *alpha, scs_float *a, blasint *lda, scs_float *beta, 
        scs_float *c, blasint *ldc);

/* void BLAS(gemm)(const char *transa, const char *transb, blasint *m, blasint * n, blasint *k, scs_float *alpha, scs_float *a, blasint *lda,
