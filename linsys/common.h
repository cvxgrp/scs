...
void BLAS(gemv)(const char *trans, blasint *m, blasint *n, scs_float *alpha,
                scs_float *a, blasint *lda, const scs_float *x, blasint *incx,
                scs_float *beta, scs_float *y, blasint *incy);
void BLAS(axpy)(blasint *n, scs_float *da, scs_float *dx, blasint *incx,
                scs_float *dy, blasint *incy_);
...
void _accumByAtrans(const AMatrix *A, Priv *p, const scs_float *x,
                    scs_float *y);
