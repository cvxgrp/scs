...
cmd = sprintf ('%s ../linsys/direct/external/ldl.c %s ../linsys/direct/private.c LINKLIBS="\\$LINKLIBS -lm %s %s" -output scs_direct', cmd, common_scs, flags.LOCS, flags.BLASLIB) ;
eval(cmd);
