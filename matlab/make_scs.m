...
%flags.LCFLAG = '-DMATLAB_MEX_FILE -DLAPACK_LIB_FOUND -DCTRLC=1 -DCOPYAMATRIX -DEXTRA_VERBOSE';
flags.INCS = '';
flags.LOCS = '';

common_scs = '../src/lin_alg.c ../src/cones.c ../src/accel.c ../src/cs.c ../src/util.c ../src/scs.c ../src/ctrlc.c ../linsys/common.c ../src/scs_version.c scs_mex.c';
